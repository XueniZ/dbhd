...
#fünfte Formel
minClusterSize_5 = math.log2(len(features_array)) + features.shape[1]
...
for rho in np.arange(0.1, 2, 0.1):
    ...
    y_pred = LDClus(features_array, estimate_n_5, rho, beta) #return Labels
...
plt.title('AMI and NMI results with different rho values(estimated n_5)')
